...
#SBATCH -D /lustre/nyx/hades/user/azaytsev/SimData/SMASH/TMP/
#SBATCH -J smash_gen
#SBATCH -p main
#SBATCH --time=05:00:00
#SBATCH -a 1-1000
#SBATCH -o /lustre/nyx/hades/user/azaytsev/SimData/SMASH/SGE_OUT/slurm_%A_%a.out
#SBATCH -e /lustre/nyx/hades/user/azaytsev/SimData/SMASH/SGE_OUT/slurm_%A_%a.err
